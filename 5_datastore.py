...
}  # The value of the key, "medical" is a list
...
for dict in list1:  # Represents a dictionary in a list
    ...
    )  # Be sure to change type to str for variables since you are writing in a csv file
